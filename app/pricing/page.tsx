...
export default function PricingPage() {
  const faqs = [
    ...
    {
      question: "What happens if I need additional users?",
      answer: "Additional users cost €48/month each, or €33.60/month each when billed yearly (30% discount).",
    },
    {
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <Card className="border-2 border-gray-200 hover:border-blue-300 transition-colors">
              <CardHeader className="text-center">
                <CardTitle className="text-2xl">Additional User</CardTitle>
                <div className="text-4xl font-bold text-gray-900 mt-4">
                  €48
                  <span className="text-lg text-gray-600">/user/month</span>
                </div>
                <CardDescription>30% off for additional team members</CardDescription>
                <div className="flex items-center justify-center gap-2">
              ...
              <CardContent>
                ...
                <Link href="/payment?plan=additional">
                  <Button className="w-full mb-3">
                    <CreditCard className="mr-2 h-4 w-4" />
                    Buy Now
                  </Button>
